...
//   //Notes:
//   //Selecting AM or PM will cause all of the other times to automatically be the same
//   //Make another button that shows up for same time or custom time
//   //Same time will make the time for all events the same, this will be default, and custom event will let you manually input the time, and will not be linked to any other time.
...
//     const [tasks, setTasks] = useState([]);
//     const [editMode, setEditMode] = useState(false);
//     const [firstDayOfWeek, setFirstDayOfWeek] = useState('Sunday'); // New state for first day of the week
//     const taskListify = new TaskListify();
...
//                 {/* Second Rectangle: Display Settings */}
//                 <div style={{ border: '1px solid #005b96', borderRadius: '10px', padding: '20px', marginBottom: '20px' }}>
//                     <label style={{ fontWeight: 'bold', color: '#005b96' }}>Change 1 Time:</label>
